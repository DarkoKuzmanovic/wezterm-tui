...
from wezterm_tui.schema import CATEGORIES, get_direct_lua_map
...
DIRECT_MAP = get_direct_lua_map()

SECTION_LABELS = {cat_id: cat_label for cat_id, cat_label in CATEGORIES}
